...
CSV_FILES_TO_LOAD = {
    ...
    'model1': 'model1(custom)_confidence_analysis.csv',
    'model2': 'model2(random)_confidence_analysis.csv',
    'model3': 'model3(combined)_confidence_analysis.csv'
}
