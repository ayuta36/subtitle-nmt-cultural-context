# -----------------------------------------------------------------
# ベースモデルによるテストセットの翻訳を出力を保存するプログラム
# -----------------------------------------------------------------
...
CONFIG = {
    # (例1: Baselineモデル)
    "MODEL_PATH": "Helsinki-NLP/opus-mt-ja-en", # model
    "OUTPUT_TRANSLATION_FILE": "baseline_output.txt", # 出力ファイル
}
...
try:
    # Helsinki-NLPモデルは AutoModelForSeq2SeqLM を使います
