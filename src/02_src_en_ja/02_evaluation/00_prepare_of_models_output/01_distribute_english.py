...
# --- 1. 設定: (重要) ここをご自身のファイルパスに編集してください ---

# 元になるCSVファイルのパス
CSV_FILE_PATH = './test_set_sample.csv'

# CSVファイル内の「原文（日本語）」の列名
JAPANESE_COLUMN_NAME = 'english'

# CSVファイル内の「参照訳（英語）」の列名
ENGLISH_COLUMN_NAME = 'japanese'

# --- 出力ファイル名---
OUTPUT_SOURCE_FILE = './test_source.en'      # 推論スクリプトが読み込む原文ファイル
OUTPUT_REFERENCE_FILE = './test_reference.ja'  # 評価に使う参照訳ファイル
