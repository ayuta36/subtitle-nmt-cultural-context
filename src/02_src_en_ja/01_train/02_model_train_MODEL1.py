...
# 7. 最終モデルの保存
# -----------------------------------------------------------------
final_model_path = f"./model_{MODEL_ID}_enja_final_second"
...
if train_loss and eval_metrics:
    ...
    plt.tight_layout()
    plt.savefig(f"metrics_model_{MODEL_ID}_enja_second.png")
    print(f"グラフを metrics_model_{MODEL_ID}_enja_second.png として保存しました。")